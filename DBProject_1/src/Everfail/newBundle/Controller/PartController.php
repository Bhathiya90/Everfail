...
class PartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EverfailnewBundle:Part')->findAll();

        return $this->render('EverfailnewBundle:Part:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EverfailnewBundle:Part:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EverfailnewBundle:Part')->find($id);
        ...
        return $this->render('EverfailnewBundle:Part:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EverfailnewBundle:Part:edit.html.twig', array(
            'entity'      => $entity,
